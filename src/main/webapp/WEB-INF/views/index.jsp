		...
		<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					    <div class="hovereffect">
					    	<div class="activity-item">
						        <img class="img-responsive" src="${cp}/images/activity1.png" alt="">
						            <div class="overlay">
						                <h2>MT</h2>
						                <div>
						                	<a href="#activity1">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					    <div class="hovereffect">
					    	<div class="activity-item">
						        <img class="img-responsive" src="${cp}/images/activity2.png" alt="">
						            <div class="overlay">
						                <h2>세션/스터디/강연</h2>
										<div>
						                	<a href="#activity2">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					    <div class="hovereffect">
					    	<div class="activity-item">
						        <img class="img-responsive" src="${cp}/images/activity3.png" alt="">
						            <div class="overlay">
						                <h2>Conference</h2>
										<div>
						                	<a href="#activity3">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					    <div class="hovereffect">
					    	<div class="activity-item">
						        <img class="img-responsive" src="${cp}/images/activity4.png" alt="">
						            <div class="overlay">
						                <h2>친목활동</h2>
										<div>
						                	<a href="#activity4">

					...
					<div id="activity1" aria-hidden="true">
						<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
							<div class="caption">
								...
								<p>해당 기수에 YB로 뽑힌 회원들과 희망하는 OB회원들과 함께 운영진들과의 첫 만남을 MT로 진행한다.<br>
									첫 만남인만큼 TAVE가 무엇을 하는 곳인지에 대한 소개와 간단한 운영진 자기소개 시간을 갖는다.<br>
									다양한 단체게임과 조끼리의 레크레이션을 통하여 서로를 알아간다.<br>
								</p>
							</div>
						</div>
					</div>
					...
					<div id="activity2" aria-hidden="true">
						<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
							<div class="caption">
								...
								<p>매주 정기적인 세션에서 스터디와 프로젝트를 진행하며 실력을 쌓는다.<br>
									세션은 상반기 하반기로 나뉘며 기수당 총 2번 나누어서 스터디와 프로젝트를 선택할 수 있다. <br>
									뿐만 아니라 원하는 스터디와 프로젝트가 있다면 직접 개설할 수 있다. <br>
									가끔은 외부 강사를 초청해 IT에 대한 강연을 진행하기도 한다.<br>
								</p>
							</div>
						</div>
					</div>
					...
					<div id="activity3" aria-hidden="true">
						<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
							<div class="caption">
								...
								<p>컨퍼런스를 통해 해당 기수 우수 프로젝트를 선정한다. <br>
									각 팀에서 프로젝트에 대한 발표를 진행하고 회원들끼리 투표하여 우수팀을 선정한다. <br>
									우수팀에게는 순위에 따라 상금도 제공된다.<br>
								</p>
							</div>
						</div>
					</div>
					...
					<div id="activity4" aria-hidden="true">
						<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
							<div class="caption">
								...
								<p>스터디나 프로젝트 뿐만 아니라 격주로 세션이 끝나고 뒷풀이를 진행한다. <br>
									음주 뿐만 아니라 볼링, 보드게임, 소풍 등 다양한 친목활동이 이루어진다.<br>
									부가적으로 멤버들이 번개를 열어 친목을 다지기도 한다.<br>
								</p>
							</div>
						</div>
					</div>
